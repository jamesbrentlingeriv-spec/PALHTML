              ...
              >
                <div className="flex justify-between items-start mb-2">
                  ...
                  {(isSelected || isCommercial) && (
                    <Check
                      className={`w-3 h-3 transition-opacity ${isSelected ? "text-green-600 opacity-100" : "text-theme-accent opacity-0 group-hover:opacity-100"}`}
                    />
                  )}
                </div>
                <h4
                ...
                <div className="flex items-baseline gap-1">
                  ...
                  />
                  <span
                    className={`text-[11px] font-black transition-colors ${isSelected ? "text-green-600" : isCommercial ? "text-theme-accent" : "text-theme-text"}`}
                  >
