...
export default function CMSFormWizard({ step, data, onChange }: WizardProps) {
  ...
  // Properly typed updateNested function
  const updateNested = <K extends keyof CMS1500Data>(
    key: K,
    subKey: string,
    value: StringOrBoolean,
  ) => {
    const parent = data[key] as Record<string, StringOrBoolean>;
    updateData({
      [key]: { ...parent, [subKey]: value },
    } as Partial<CMS1500Data>);
  };
        ...
        return (
          <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <header className="flex items-center justify-between">
              ...
              <span className="text-[10px] text-green-600 bg-green-50 px-3 py-1 rounded-full font-bold border border-green-100 uppercase tracking-widest">
                Validated
              </span>
            </header>
              ...
              <div className="space-y-6">
                <label className="block">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      updateData({ programType: e.target.value as CMS1500Data['programType'] })
                    }
                ...
                <label className="block">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateData({ patientName: e.target.value })
                    }
                ...
                <div className="grid grid-cols-2 gap-4">
                  <label className="block">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateData({ patientBirthDate: e.target.value })
                      }
                  ...
                  <label className="block">
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        updateData({ patientSex: e.target.value as CMS1500Data['patientSex'] })
                      }
              ...
              <div className="space-y-6">
                <label className="block">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateNested("patientAddress", "street", e.target.value)
                    }
                ...
                <div className="grid grid-cols-2 gap-4">
                  <label className="block">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateNested("patientAddress", "city", e.target.value)
                      }
                ...
                <label className="block">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      updateData({ patientRelationship: e.target.value as CMS1500Data['patientRelationship'] })
                    }
                    className="block w-full rounded-lg border-slate-200 bg-slate-50 border px-3 py-2 text-sm focus:ring-2 focus:ring-primary transition-all font-medium"
                  >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-6">
                ...
                <label className="block">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateData({ insuredName: e.target.value })
                    }
                ...
                <div className="grid grid-cols-2 gap-4">
                  <label className="block">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateData({ insuredGroupNumber: e.target.value })
                      }
                      className="block w-full rounded-lg border-slate-200 bg-slate-50 border px-3 py-2 text-sm focus:ring-2 focus:ring-primary font-mono"
                    />
                  </label>
                  <label className="block">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateData({ insuredPlanName: e.target.value })
                      }
                      className="block w-full rounded-lg border-slate-200 bg-slate-50 border px-3 py-2 text-sm focus:ring-2 focus:ring-primary"
                    />
                  </label>
              ...
              <div className="space-y-6">
                <div className="p-6 bg-slate-50 rounded-2xl border border-slate-200 space-y-4">
                  ...
                  <label className="flex items-center gap-3 cursor-pointer group">
                    <input
                      ...
                      onChange={(e) =>
                        updateData({
                          insuredSignatureAuthorized: e.target.checked,
                        })
                      }
                  ...
                  <label className="block">
                    <span className="text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-1 block">
                      Patient Sign Date (Box 12)
                    </span>
                    <input
                      type="date"
                      value={data.patientSignatureDate}
                      onChange={(e) =>
                        updateData({ patientSignatureDate: e.target.value })
                      }
                ...
                <div className="flex items-start gap-3 p-4 bg-red-50 rounded-2xl border border-red-100 text-red-900 text-[11px] leading-relaxed font-medium">
                  ...
                  Note: Box 7 (Insured Address) remains blank if relationship is
                  "Self" to prevent redundant data on the printed form.
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-6">
                <div className="grid grid-cols-2 gap-4">
                  <label className="block">
                    <span className="text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-1 block">
                      Date of Illness (Box 14)
                    </span>
                    <input
                      type="date"
                      value={data.dateOfIllness}
                      onChange={(e) =>
                        updateData({ dateOfIllness: e.target.value })
                      }
                      className="block w-full rounded-lg border-slate-200 bg-slate-50 border px-3 py-2 text-sm focus:ring-2 focus:ring-primary transition-all font-mono"
                    />
                  </label>
                  <label className="block">
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        updateData({ dateOfIllnessQual: e.target.value as CMS1500Data['dateOfIllnessQual'] })
                      }
              ...
              <div className="space-y-4">
                <label className="block">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateData({ referringProviderName: e.target.value })
                    }
                ...
                <div className="grid grid-cols-2 gap-4">
                  <label className="block">
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        updateData({
                          referringProviderQual: e.target.value as CMS1500Data['referringProviderQual'],
                        })
                      }
                      className="block w-full rounded-lg border-slate-200 bg-slate-50 border px-3 py-2 text-sm focus:ring-2 focus:ring-primary transition-all font-mono"
                    >
                  ...
                  <label className="block">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateData({ referringProviderNpi: e.target.value })
                      }
                ...
                <label className="block">
                  <span className="text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-1 block">
                    Prior Auth Number (Box 23)
                  </span>
                  <input
                    type="text"
                    value={data.priorAuthNumber}
                    onChange={(e) =>
                      updateData({ priorAuthNumber: e.target.value })
                    }
                    className="block w-full rounded-lg border-slate-200 bg-slate-50 border px-3 py-2 text-sm focus:ring-2 focus:ring-primary transition-all font-mono"
                  />
                </label>
        ...
        return (
          <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <div className="flex items-center gap-8 mb-8 relative z-10">
                ...
                <div className="flex gap-6">
                  <label className="flex items-center gap-3 cursor-pointer group">
                    ...
                    />
                    <span className="font-bold text-[11px] uppercase tracking-wider text-slate-600 group-hover:text-slate-900 transition-colors">
                      ICD-10 (0)
                    </span>
                  </label>
                  <label className="flex items-center gap-3 cursor-pointer group">
            ...
            <div className="bg-slate-900 p-5 rounded-2xl text-slate-400 text-[11px] leading-relaxed font-medium">
              <span className="text-red-400 font-black uppercase tracking-widest mr-2">
                System Note
              </span>
              Diagnosis pointers are linked in sequential order (A-L). These
              pointers must match the 'DIAG' field in Service Lines for accurate
              adjudication.
            </div>
          </div>
        );
                    ...
                    >
                        ...
                        <div className="flex flex-col gap-1.5">
                          <input
                            ...
                            onChange={(e) => {
                              ...
                              lines[idx].fromDate = e.target.value;
                              updateData({ serviceLines: lines });
                            }}
                          ...
                          <input
                            ...
                            onChange={(e) => {
                              const lines = [...data.serviceLines];
                              lines[idx].toDate = e.target.value;
                              updateData({ serviceLines: lines });
                            }}
                      ...
                      <td className="py-3 px-2">
                        <input
                          ...
                          onChange={(e) => {
                            const lines = [...data.serviceLines];
                            lines[idx].placeOfService = e.target.value;
                            updateData({ serviceLines: lines });
                          }}
                      ...
                      <td className="py-3 px-4">
                        <input
                          ...
                          onChange={(e) => {
                            const lines = [...data.serviceLines];
                            lines[idx].cptCode = e.target.value;
                            updateData({ serviceLines: lines });
                          }}
                      ...
                      <td className="py-3 px-2">
                        <input
                          ...
                          onChange={(e) => {
                            const lines = [...data.serviceLines];
                            lines[idx].modifier = e.target.value;
                            updateData({ serviceLines: lines });
                          }}
                      ...
                      <td className="py-3 px-4">
                        <div className="flex items-center gap-1.5 px-2 py-2 border border-slate-100 rounded bg-slate-50 group-focus-within:bg-white transition-all">
                          ...
                          <input
                            ...
                            onChange={(e) => {
                              const lines = [...data.serviceLines];
                              lines[idx].charges = e.target.value;
                              updateData({ serviceLines: lines });
                            }}
                      ...
                      <td className="py-3 px-2">
                        <input
                          type="text"
                          value={line.daysOrUnits}
                          onChange={(e) => {
                            const lines = [...data.serviceLines];
                            lines[idx].daysOrUnits = e.target.value;
                            updateData({ serviceLines: lines });
                          }}
                      ...
                      <td className="py-3 px-4">
                        <input
                          ...
                          onChange={(e) => {
                            const lines = [...data.serviceLines];
                            lines[idx].renderingProviderNpi = e.target.value;
                            updateData({ serviceLines: lines });
                          }}
                      ...
                      <td className="py-3 px-4 text-right">
                        {data.serviceLines.length > 1 && (
                          <button
                            onClick={() =>
                              updateData({
                                serviceLines: data.serviceLines.filter(
                                  (_, i) => i !== idx,
                                ),
                              })
                            }
              ...
              <div className="p-6 bg-slate-900 rounded-3xl flex justify-between items-center shadow-lg shadow-slate-200">
                ...
                <div className="flex items-baseline gap-2">
                  ...
                  <input
                    ...
                    placeholder="0.00"
                    onChange={(e) =>
                      updateData({ totalCharge: e.target.value })
                    }
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-8">
                <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm space-y-4">
                  <span className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-300 block">
                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="w-1/3">
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          updateData({ taxIdType: e.target.value as CMS1500Data['taxIdType'] })
                        }
                ...
                <div className="p-6 bg-slate-50 rounded-3xl border border-slate-200 shadow-sm space-y-5">
                  ...
                  <div className="space-y-3">
                    <input
                      ...
                      onChange={(e) =>
                        updateNested("facilityInfo", "name", e.target.value)
                      }
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateNested("facilityInfo", "street", e.target.value)
                      }
                    ...
                    <div className="grid grid-cols-4 gap-2">
                      <input
                        ...
                        onChange={(e) =>
                          updateNested("facilityInfo", "city", e.target.value)
                        }
                  ...
                  <div className="pt-2 border-t border-slate-200">
                    ...
                    <input
                      type="text"
                      value={data.facilityInfo.npi}
                      onChange={(e) =>
                        updateNested("facilityInfo", "npi", e.target.value)
                      }
              ...
              <div className="p-8 bg-slate-900 rounded-3xl space-y-6 shadow-xl relative overflow-hidden">
                ...
                <h3 className="text-[10px] font-black uppercase tracking-[0.4em] text-slate-500 mb-2 relative z-10">
                ...
                <div className="space-y-4 relative z-10">
                  ...
                  <div className="grid grid-cols-2 gap-4 pt-4 border-t border-slate-800">
                    <div>
                      ...
                      <input
                        type="text"
                        value={data.billingProviderInfo.npi}
                        onChange={(e) =>
                          updateNested(
                            "billingProviderInfo",
                            "npi",
                    ...
                    <div>
                      ...
                      <input
                        type="text"
                        value={data.billingProviderInfo.otherId}
                        onChange={(e) =>
                          updateNested(
                            "billingProviderInfo",
                            "otherId",
                ...
                <div className="pt-6 relative z-10">
                  <div className="p-4 bg-primary/5 rounded-xl border border-primary/20">
                    <label className="text-[10px] font-black text-primary uppercase tracking-[0.2em] mb-2 block">
                      Physician Attestation Date
                    </label>
                    <input
                      type="date"
                      value={data.physicianSignatureDate}
                      onChange={(e) =>
                        updateData({ physicianSignatureDate: e.target.value })
                      }
  ...
  return <div className="w-full">{handleStepRender()}</div>;
}
