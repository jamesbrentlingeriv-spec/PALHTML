            ...
            {[1, 2].map((n) => (
              ...
              >
                ...
                <div className="flex justify-between items-start mb-2">
                  <h1 className="text-3xl font-black border-2 border-black px-3 py-1">
                    P.O.S.T.
                  </h1>
                  <div className="text-right">
                ...
                <div className="space-y-1 text-[11px] font-bold uppercase">
                  ...
                  {promise.mail && mailAddress && (
                    <div className="border-b border-black flex flex-col py-0.5">
                      <span className="text-[9px]">Mailing Address:</span>
                      <span className="text-[10px] whitespace-pre-wrap leading-tight">
                        {mailAddress}
                      </span>
                    </div>
                  )}
