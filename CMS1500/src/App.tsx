...
import { FileText, Printer, ChevronRight, ChevronLeft, Save, Plus, Trash2, CheckCircle2 } from 'lucide-react';
      ...
      <header className="bg-white border-b border-border sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 bg-primary rounded flex items-center justify-center text-white shadow-sm shadow-red-200">
              <FileText size={20} />
            </div>
            <div>
              <h1 className="font-bold text-xl leading-none tracking-tight">MediForm<span className="text-primary">Pro</span></h1>
              <p className="text-[10px] text-muted mt-1 uppercase tracking-[0.2em] font-black">CMS-1500 Clinical Systems</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="px-5 py-2 text-sm font-bold bg-primary text-white rounded-md shadow-sm shadow-red-200 hover:bg-primary-hover transition-all flex items-center gap-2"
            >
          ...
          {view === 'EDIT' ? (
            ...
            >
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <span className={`w-6 h-6 rounded flex items-center justify-center text-[10px] font-black ${
                        currentStep === step.key ? 'bg-primary text-white' : 'bg-slate-200 text-slate-500'
                      }`}>
                    ...
                    {currentStep === step.key && <ChevronRight size={16} className="text-primary" />}
                  </button>
                ))}
              ...
              <div className="lg:col-span-9">
                <div className="bg-white rounded-2xl p-8 border border-border shadow-sm min-h-[600px] flex flex-col relative overflow-hidden">
            ...
            >
              <div className="w-full max-w-4xl mb-8 flex items-center justify-between bg-white p-6 rounded-2xl border border-slate-200">
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-red-50 rounded-xl flex items-center justify-center text-primary border border-red-100">
                    <Printer size={24} />
                  </div>
                  <div>
                ...
                <div className="flex items-center gap-6">
                  ...
                  <button
                    ...
                    className="px-6 py-3 bg-primary text-white rounded-xl text-xs font-black uppercase tracking-[0.2em] shadow-lg shadow-red-100 hover:bg-primary-hover transition-all flex items-center gap-2"
                  >
                    <Printer size={16} />
                    Execute Print
                  </button>
